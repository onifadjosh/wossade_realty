...
const StatSection = () => {
  return (
    <div className='py-10 px-4 flex flex-col justify-center lg:flex-row gap-6 bg-emerald-900'>
        <StatCard stat="10" title="Years of Experience" subtitle="Building excellence in since 2005"/>

        <StatCard stat="10" title="Projects Completed" subtitle="Successful construction projects"/>
